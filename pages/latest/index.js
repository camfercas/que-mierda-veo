...
export async function getServerSideProps({ query }) {
  ...
  const res = await fetch(
    `https://streaming-availability.p.rapidapi.com/search/ultra?country=ar&services=${services}&type=movie&order_by=${orderBy}&year_min=2020&year_max=2021&page=${page}&desc=true&min_imdb_rating=60&max_imdb_rating=90&min_imdb_vote_count=10000&max_imdb_vote_count=1000000`,
    {
      method: "GET",
      headers: {
  ...
  return (
    <>
      <div className="flex justify-between">
        <p className="text-white text-xl p-4 font-bold">Últimos estrenos</p>
